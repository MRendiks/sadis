...
Installing and running sadis is super easy, please follow the steps below and you will be ready to rock 🤘

1. Open the terminal in your root directory of sadis Laravel.
...
Check GitHub [Wiki](https://github.com/MRendiks/sadis.git) of this repo
